      ...
      <div className="row gx-4">
        <div className="col-auto">
          <div className="avatar avatar-xl position-relative">
            {user.avatar && <img src={user.avatar.url} alt="..." className="w-100 border-radius-lg shadow-sm" />}
            <input type="file" className=" fa fa-pen btn btn-sm btn-icon-only bg-gradient-light position-absolute bottom-0 end-0 mb-n2 me-n2"/>
